            ...
            <div class="layui-col-xs12 pl15 pr15 posi-rela z-index">
                <div class="layui-col-xs12 border-radius-4 box-shadow-ext1 bg-fff notice-margin-ext1 pl15 pt10 pr15 pb15">
                    ...
                    <div class="flex flex-ac flex-jb mt5">
                        <div class="flex flex-ac" id="SignStatus">
                ...
                <div class="layui-col-xs12 pb25" id="personalInfo">
                    <p class="posi-rela text-lh1 font-size-15 cor-333 pl15 mt20" ><i class="notic-bar-ext1"></i>活动介绍</p>
...
<script>
    var url = '${$WECHAT_DOMAIN}/public/wap/ruralGovernanceControllerApp/getDataByIdForJsonp.json'
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data!=null && data!=undefined){
                ...
                $("#name").html(data.bo.title)
                $("#addr").html(data.bo.address)
                $("#personalInfo").append(data.bo.content)
                // $("#SignStatus").html(labels)
            }
