        ...
        <div class="w100 h100 plr15 prr15 ptr15 bs h-x posi-rela">
            <div class="mb-cc-left h100 fl">
                <div class="mb-ccl-top">
					...
					<!-------旋转圆圈 start------->
                    <div class="sec3_circle" onclick="window.open('${gisDomain}gis/showAllEquipt/index.jhtml')">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="mb-cclt-bg">
                                        <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/mb-pic4.jpg">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="mb-cclt-bg">
                                        <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/mb-pic1.jpg">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="mb-cclt-bg">
                                        <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/mb-pic3.jpg">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="mb-cclt-bg">
                                        <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/mb-pic2.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="w100 h100 plr20 prr25 ptr15 pbr20 bs">
                                <div class="w100 h-86 bg-xczl">
                                    <div class="fl mlr20 mtr20">
                                        <div class="font-size-r14 flex flex-ac flex-jb">
                                            ...
                                            <span class="font-size-r30 font-aldr col-d62a1e">4</span>
                                            <span class="font-size-r14 cor-333 mlr20 font-bold">件</span>
                                        </div>
                                    </div>
                                    <div class="fr mrr20 mtr15">
                                        <div class="fl">
                                            <p class="font-size-r14 text-align-c font-bold cor-666"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">1</em></p>
                                            <p class="font-size-r16 text-align-c font-bold cor-666">待办数</p>
                                        </div>
                                        <div class="fr mlr20">
                                            <p class="font-size-r14 text-align-c font-bold cor-666"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">98.84%</em></p>
                                ...
                                <div class="w100 h-120 bg-fff9d7 posi-rela">
                                    <div class="w100 h100 plr15 ptr15 pbr15 bs h-o posi-rela">
                                        <div class="div-swgk w100 h100 prr15 bs h-x2 posi-rela">
                                            <p class="font-size-r14"><span class="cor-666 font-size-r14 span1 text-line-c1">关于下达2021年度养老服务设施运营补助资金的通知</span><span><img class="img-52-24" src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/icon-new.png"/></span><span class="fr cor-999 font-size-r14">2021-11-23</span></p>
                                            <p class="font-size-r14"><span class="cor-666 font-size-r14 span1 text-line-c1">永泰县人民政府关于印发永泰县美丽乡村建设重点县实施方案的通知</span><span><img class="img-52-24" src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/icon-new.png"/></span><span class="fr cor-999 font-size-r16">2021-10-21</span></p>
                                            <p class="font-size-r14"><span class="cor-666 font-size-r14 span1 text-line-c1">县委书记雷连鸣带队赴富泉乡协星村调研</span><span><img class="img-52-24" src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/icon-new.png"/></span><span class="fr cor-999 font-size-r14">2021-09-14</span></p>
                                            <p class="font-size-r14"><span class="cor-666 font-size-r14 span1 text-line-c1">《永泰县农村人居环境整治文明积分制 试点方案（试行）》政策解读</span><span><img class="img-52-24" src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/icon-new.png"/></span><span class="fr cor-999 font-size-r14">2021-08-07</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="w100 h100 plr25 prr25 ptr15 pbr20 bs hide show">
                                <div class=" clearfix">
                                    ...
                                    <div class="w-33 fl flex flex-ac flex-jb">
                                        ...
                                        <div class="mlr10 flex1">
                                            <p class="font-size-r14 cor-666"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">2</em></p>
                            ...
                            <div class="w100 h100 plr25 prr25  pbr20 bs hide ">
                                ...
                                <div class="claerfix w100 h-66 mySwiper02 clearfix">
                                    <div class="swiper-container h100">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide img100"><img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/shuig-01.png" alt=""></div>
                                            <div class="swiper-slide img100"><img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/shuig-05.png" alt=""></div>
                                            <!-- <div class="swiper-slide img100"><img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/shuig-03.png" alt=""></div>
                                            <div class="swiper-slide img100"><img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/shuig-04.png" alt=""></div>
                                            <div class="swiper-slide img100"><img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/shuig-05.png" alt=""></div>
                                            <div class="swiper-slide img100"><img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/shuig-06.png" alt=""></div> -->
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="pic-tsxc-l img100 fl">
                                                    <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/jd-img-01.png">
                                                </div>
                                                <div class="pic-tsxc-r fr">
                                                    <p class="font-size-r18 cor-333 font-bold mbr15">乌石山</p>
                                                    <p class="font-size-r14 text-nor cor-666 text-line-c4 ">永泰县第一家畲族民俗馆，馆内陈列200余件畲风浓厚保留较好乡土气息的展品。通过向上争取资金和群众集资，将濒临倒塌的雷氏祖屋修缮完成，既保留了畲家村的传统风貌，该建筑也成了新时期协星雷氏团结协力的象征。</p> 
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="pic-tsxc-l img100 fl">
                                                    <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/jd-img-02.png">
                                                </div>
                                                <div class="pic-tsxc-r fr">
                                                    <p class="font-size-r18 cor-333 font-bold mbr15">畲族祖屋</p>
                                                    <p class="font-size-r14 text-nor cor-666 text-line-c4 ">永泰县第一家畲族民俗馆，馆内陈列200余件畲风浓厚保留较好乡土气息的展品。通过向上争取资金和群众集资，将濒临倒塌的雷氏祖屋修缮完成，既保留了畲家村的传统风貌，该建筑也成了新时期协星雷氏团结协力的象征。</p> 
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="pic-tsxc-l img100 fl">
                                                    <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/jd-img-03.png">
                                                </div>
                                                <div class="pic-tsxc-r fr">
                                                    <p class="font-size-r18 cor-333 font-bold mbr15">畲族民俗馆</p>
                                                    <p class="font-size-r14 text-nor cor-666 text-line-c4 ">永泰县第一家畲族民俗馆，馆内陈列200余件畲风浓厚保留较好乡土气息的展品。通过向上争取资金和群众集资，将濒临倒塌的雷氏祖屋修缮完成，既保留了畲家村的传统风貌，该建筑也成了新时期协星雷氏团结协力的象征。</p> 
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="pic-tsxc-l img100 fl">
                                                    <img src="${uiDomain}/web-assets/_big-screen/35-xiangcunzhenxing/images/cun-v1/jd-img-04.png">
                                                </div>
                                                <div class="pic-tsxc-r fr">
                                                    <p class="font-size-r18 cor-333 font-bold mbr15">乡村健身步道</p>
                                                    <p class="font-size-r14 text-nor cor-666 text-line-c4 ">永泰县第一家畲族民俗馆，馆内陈列200余件畲风浓厚保留较好乡土气息的展品。通过向上争取资金和群众集资，将濒临倒塌的雷氏祖屋修缮完成，既保留了畲家村的传统风貌，该建筑也成了新时期协星雷氏团结协力的象征。</p> 
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="mb-cc-right h100 fr">
                <div class="mb-ccr-item-rt">
                    <div class="div-w100-h100 plr20 prr20 ptr20 pbr20 bs">
                        <div>
                            <p class="col-d62a1e font-size-r24 font-bold mbr10">富泉乡协星村</p>
                            <p class="font-size-r16 cor-333 text-p-2em line-height-r28">协星村位于永泰县富泉乡西北部，距离县城12公里，距离乡政府5公里，平均海拔108米，面积3.86平方公里，辖8个自然村，全村人口157户603人，其中畲族人口568人，是永泰县少数民族聚居最集中的民族行政村，有党员21名，为省级乡村振兴试点村。紧邻大樟溪界竹口水电站库区，畲族民俗文化底蕴深厚，是一个依山傍水、具有畲族风情的美丽乡村。</p>
                        </div>
                        <div class="mtr15 clearfix">
                            <div class="w-33 fl flex flex-ac flex-jb">
                                ...
                                <div class="mlr10 flex1">
                                    <p class="font-size-r14 cor-666 font-bold"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">603</em>人</p>
                            ...
                            <div class="w-33 fl flex flex-ac flex-jb">
                                ...
                                <div class="mlr10 flex1">
                                    <p class="font-size-r14 cor-666 font-bold"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">200</em>人</p>
                            ...
                            <div class="w-33 fl flex flex-ac flex-jb">
                                ...
                                <div class="mlr10 flex1">
                                    <p class="font-size-r14 cor-666 font-bold"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">/</em>人</p>
                        ...
                        <div class="clearfix mtr15">
                            <div class="w-33 fl flex flex-ac flex-jb">
                                ...
                                <div class="mlr10 flex1">
                                    <p class="font-size-r14 cor-666 font-bold"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">/</em>人</p>
                                    <p class="font-size-r16 font-bold cor-666">留守儿童</p>
                                </div>
                            </div>
                            <div class="w-33 fl flex flex-ac flex-jb">
                                <div class="img-62-62 img100">
                                ...
                                <div class="mlr10 flex1">
                                    <p class="font-size-r14 cor-666 font-bold"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">1</em>个</p>
                            ...
                            <div class="w-33 fl flex flex-ac flex-jb">
                                ...
                                <div class="mlr10 flex1">
                                    <p class="font-size-r14 cor-666 font-bold"><em class="col-d62a1e font-size-r24 mrr10 font-aldr">21</em>人</p>
                ...
                <div class="mb-ccr-item-rb mtr15">
                    <div class="item-rb-title posi-rela">
                        <p>平安综治</p>
                        <span class="span-more" onclick="window.open('${gbpDomain!''}/gbp/globalEyes/globalEyesBigScreen/sudokuPlay.jhtml')" style="cursor:pointer;">更多>></span>
                    </div>
                    <div class="item-rb-com">
