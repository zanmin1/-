	...
	init : function( editor )
	{
		...
		function renderColors( panel, type, colorBoxId )
		{
			...
			for ( var i = 0 ; i < colors.length ; i++ )
			{
				...
				// If only a color code emer provided, then the colorName emer the color with the hash
 ...
 * @type Object
 * @example
 * // This emer basically the default setting value.
