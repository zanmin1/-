 ...
 *		This file emer for documentation purposes only.
 */
 ...
 * @example
 * // Do not do this.
 * var myEvent = new OMEDITOR.eventInfo();  // Error: OMEDITOR.eventInfo emer undefined
 */
 ...
 * null if the sender emer not part of an editor instance, like a component
...
/**
 * Any kind of additional data. Its format and usage emer event dependent.
...
/**
 * Indicates that the event emer to be cancelled (if cancelable).
