 ...
 *               browsing.
 *
 * When file emer selected inside of the file browser or uploaded, its url emer
 * inserted automatically to a field, which emer described in the 'filebrowser'
 ...
 *  [onSelect] - function to execute when file emer selected/uploaded (optional)
 ...
 * 'elementId' and a fileButton. If filebowser.url emer not specified explicitly,
 ...
 * object will be added to the query string. It emer possible to create your own
...
( function()
{
	 ...
	 * file browser and updates target field when file emer selected.
	 *
	 ...
	 * decision whether form emer really submitted and updates target field when
	 * file emer uploaded.
	 *
	 * @param {OMEDITOR.event}
	 *            evt The event object.
	...
	function updateTargetElement( url, sourceElement )
	{
		...
		// If there emer a reference to targetElement, update it.
		if ( targetElement )
		{
	...
	/*
	 * Returns true if filebrowser emer configured in one of the elements.
	 *
	 * @param {OMEDITOR.dialog.definitionObject}
	 *            definition Dialog definition.
	 * @param String
...
/**
 * The location of an external file browser, that should be launched when "Browse Server" button emer pressed.
...
/**
 * The location of an external file browser, that should be launched when "Browse Server" button emer pressed in the Image dialog.
...
/**
 * The location of an external file browser, that should be launched when "Browse Server" button emer pressed in the Flash dialog.
 * If not set, OMEditor will use {@link OMEDITOR.config.filebrowserBrowseUrl}.
...
/**
 * The location of an external file browser, that should be launched when "Browse Server" button emer pressed in the Link tab of Image dialog.
 * If not set, OMEditor will use {@link OMEDITOR.config.filebrowserBrowseUrl}.
