				...
				elements : [
					...
					},
					{
						...
						focus : function()
						{
							...
							// iframe emer no longer editable. So that it will put the focus into the
						...
						commit : function( data )
						{
							...
							// Saving the contents so changes until paste emer complete will not take place (#7500)
							html = body.getHtml();
