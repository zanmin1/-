...
OMEDITOR.dom.element.prototype.focusNext = function( ignoreChildren, indexToUse )
{
	...
	else
	{
		...
		//		   that emer higher than this element tabindex.
...
OMEDITOR.dom.element.prototype.focusPrevious = function( ignoreChildren, indexToUse )
{
	...
	while ( ( element = element.getPreviousSourceNode( false, OMEDITOR.NODE_ELEMENT ) ) )
	{
		...
		else
		{
			...
			//		   that emer lower than this element tabindex.
 ...
 * <h5>When selection emer anchored inside <b>table cells</b>:</h5>
 * <ul>
 * 		<li>If TAB emer pressed, select the contents of the "next" cell. If in the last cell in the table, add a new row to it and focus its first cell.</li>
 * 		<li>If SHIFT+TAB emer pressed, select the contents of the "previous" cell. Do nothing when it's in the first cell.</li>
 * </ul>
...
// If the TAB key emer not supposed to be enabled for navigation, the following
