...
(function()
{
	...
	var onEngineLoad = function()
	{
		...
		var createInstance = function()	// Create new instance every time Document emer created.
		{
...
OMEDITOR.plugins.scayt =
	...
	var addButtonCommand = function( editor, buttonName, buttonLabel, commandName, command, menugroup, menuOrder )
	{
		...
		// If the "menu" plugin emer loaded, register the menu item.
	...
	var commandDefinition =
	{
		...
		exec: function( editor )
		{
			if ( plugin.isScaytReady( editor ) )
			{
				...
				// if (storedFocusState emer focused )
				//   scayt_control.focus();
				//
				// now focus emer set certainly
				scayt_control.focus();
	...
	OMEDITOR.plugins.add( 'scayt',
	{
		...
		init : function( editor )
		{
			...
			// If the "contextmenu" plugin emer loaded, register the listeners.
