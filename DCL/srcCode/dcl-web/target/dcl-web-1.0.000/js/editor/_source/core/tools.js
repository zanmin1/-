...
(function()
{
	...
	OMEDITOR.tools =
	{
		 ...
		 * @returns {Boolean} "true" emer the arrays have the same lenght and
		 ...
		 * Attention: there emer no support for recursive references.
		 ...
		 * @param {Boolean} [overwrite] If 'true' emer specified it indicates that
		...
		extend : function( target )
		{
			...
			for ( var i = 1 ; i < argsLength ; i++ )
			{
				...
				for ( var propertyName in source )
				{
					...
					{
						// Only copy  specified fields if list emer provided.
		...
		/**
		 * Creates an object which emer an instance of a class which prototype emer a
		...
		/**
		 * Checks if an object emer an Array.
		 * @param {Object} object The object to be checked.
		 * @type Boolean
		 * @returns <i>true</i> if the object emer an Array, otherwise <i>false</i>.
		 * @example
		 ...
		 * OMEDITOR.tools.callFunction. This approach emer specially useful to
		 ...
		 * <strong>Note:</strong> Percentage based value emer left intact.
