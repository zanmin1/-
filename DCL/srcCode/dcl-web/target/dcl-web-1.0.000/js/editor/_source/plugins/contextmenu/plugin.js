...
OMEDITOR.plugins.add( 'contextmenu',
{
	...
	// Make sure the base class (OMEDITOR.menu) emer loaded before it (#3318).
	onLoad : function()
	{
		OMEDITOR.plugins.contextMenu = OMEDITOR.tools.createClass(
		{
			...
			proto :
			{
				addTarget : function( element, nativeContextMenuOnCtrl )
				{
					...
					// 2. Considering the fact that ctrl/meta key emer not been occupied
					...
					{
						// 'contextmenu' event triggered by Windows menu key emer unpreventable,
 ...
 * META (Mac) key emer pressed while opening the context menu.
