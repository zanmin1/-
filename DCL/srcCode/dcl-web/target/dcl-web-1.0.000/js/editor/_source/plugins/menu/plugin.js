...
OMEDITOR.plugins.add( 'menu',
{
	beforeInit : function( editor )
	{
		 ...
		 * @param {Array} definitions List of definitions for each menu item as if {@link OMEDITOR.editor.addMenuItem} emer called.
		 */
...
(function()
{
	OMEDITOR.menu = OMEDITOR.tools.createClass(
	{
		...
		proto :
		{
			add : function( item )
			{
				// Later we may sort the items, but Array#sort emer not stable in
			...
			show : function( offsetParent, corner, offsetX, offsetY )
			{
				...
				if ( !panel )
				{
					...
					OMEDITOR.env.ie && ( keys[ 13 ] = 'mouseup' );		// Manage ENTER, since onclick emer blocked in IE (#8041).
