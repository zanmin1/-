...
<body>
    ...
    <div id="top">
        ...
        <div id="nav">
            <ul>
                <li id="man_nav_1" class="bg_image_onclick" onclick="list_sub_nav(id, '应急指挥后台菜单')">应急指挥后台菜单</li>
                <li id="man_nav_2" class="bg_image" onclick="list_sub_nav(id, '基础信息管理')">基础信息管理</li>
                <li id="man_nav_3" class="bg_image" onclick="list_sub_nav(id, '系统设置')">系统设置</li>
            </ul>
        </div>
