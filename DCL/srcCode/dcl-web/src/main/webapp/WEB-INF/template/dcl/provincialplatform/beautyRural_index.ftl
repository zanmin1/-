        ...
        <div class="mlxc-h352 mtr10">
            ...
            <div class="main-div-box mlxc-bottom-r h100 fr" id="rycyp">
                ...
                <div class="clearfix">
                    ...
                    <span class="font-size-r14 cor-d62a1e font-bold prr15 mtr10 fr cursor" onclick="ycypMore('一村一品')"><em>更多</em><i class="comm-jt mlr5"></i></span>
                </div>
...
<script>
    ...
    function ycypMore(title,id) {
        window.open(
            '${rc.getContextPath()}/dcl/xcBigScreen/xcIndex.jhtml?type=3' + '&infoOpenId='+id+'&module=village_product&title=' + encodeURI(title)
        );
    }

    function xclyMore(title,id) {
        window.open(
            '${rc.getContextPath()}/dcl/xcBigScreen/xcIndex.jhtml?type=4' + '&infoOpenId='+id+'&module=xcly&title=' + encodeURI(title)
        );
    }
