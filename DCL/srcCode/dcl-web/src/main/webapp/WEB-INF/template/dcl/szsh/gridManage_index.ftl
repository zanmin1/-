...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${UI_DOMAIN}/web-assets/_big-screen/00-shuzishenghuo/css/subject/subject-wggl-4.css" />
    <style>
        .evt-handle>li {
            margin-top: 0.3rem;
        }
    ...
    <div class="h100 szsh-bj plr20 ptr20 pbr20 bs">
        <div class="h100 prr20 clearfix">
            ...
            <div class="h100 cont-w1 fl">
                <div class="cont-h1 main-div-box" id="wggl">
                    <!-- 大标题 -->
                    <div class="comm-div-title-big flex flex-ac mlr30">
...
<#--                        <i class="comm-line-ext1"></i>-->
                        <div class="comm-subject-title-ext1 plr5 bs">
                            <p class="font-size-r20 line-height-r48 text-align-c plr10 prr10 bs cor-fff font-bold">网格管理</p>
                        </div>
                    </div>
                    <!-- 内容 -->
                    <div class="bmfw-box cont-h4 mtr30">
                        <div class="cont-box-ext1 cont-margin1 cont-h5" id="gridImg">
                        </div>
                    </div>
                </div>
                <div class="cont-h2 main-div-box mtr10" id="sjdt">
                    <!-- 小标题 -->
                    <div class="clearfix">
                        <div class="comm-div-title font-size-0 fl">
                            <em class="font-size-r16 cor-d62a1e font-bold plr15">事件动态</em>
                        </div>
                    </div>
                    <!-- 内容 -->
                    <div class="bmfw-box cont-h3 mtr10 ptr20 h-x" style="cursor: pointer;">
<#--                        onclick="openpage('${rc.getContextPath()}/dcl/xcBigScreen/xcIndex.jhtml?type=3&module=sjlb&title=辖区事件列表');"-->
            ...
            <div class="h100 cont-w2 fr">
                <div class="cont-h6 main-div-box" id="fwjs">
                    <!-- 小标题 -->
                    <div class="clearfix">
                        <div class="comm-div-title font-size-0 fl">
                            <em class="font-size-r16 cor-d62a1e font-bold plr15">服务基数</em>
                        </div>
                    </div>
                    <!-- 内容 -->
                    <div class="bmfw-box mtr25">
                        <div class="evt-report-t cont-margin1">
                            <p class="font-size-r20 text-cor4 font-bold mlr35 fl">累计上报事件</p>
                            <p class="font-size-r16 text-cor3 mrr35 fr"><em class="font-size-r20 font-bold mrr5" id="num0">0</em>件</p>
                        </div>
                        <ul class="evt-handle">
                            <li>
                ...
                <div class="cont-h7 main-div-box mtr10" id="wggly">
                    <!-- 小标题 -->
                    <div class="clearfix">
                        <div class="comm-div-title font-size-0 fl">
                            <em class="font-size-r16 cor-d62a1e font-bold plr15">网格管理员</em>
                        </div>
                    </div>
                    <!-- 内容 -->
                ...
                for (i = 0; i < list.length; i++) {
                    ...
                    str += '<li>'
                                +'<span class="manager-list-p fl">'
                                    +'<img src="'+filePath+'">'
                                +'</span>'
                                +'<div class="mlr20 w-200 fl">'
                                    +'<div class="over-hide mtr20">'
                                        +'<p class="font-size-r24 text-lh1 cor-333 font-bold text-line-c1">'+list[i].partyName+'</p>'
                                        +'<p class="manager-list-des font-size-r18 cor-fff fl mlr10 mtr10">'+list[i].dutyLabel+'</p>'
                                    +'</div>'
                              ...
                              if(list[i].responsibility!=null && list[i].responsibility!=''){
                                       str+='<div class="mlr20 w-100-300 fr">'
                                                +'<p class="text-line-c2 line-height-r24 mtr40  font-size-r16 cor-666">'
