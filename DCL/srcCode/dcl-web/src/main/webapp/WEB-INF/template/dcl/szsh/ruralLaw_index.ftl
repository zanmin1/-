...
<#--                <i class="comm-line-ext1"></i>-->
                <div class="comm-subject-title-ext1 plr5 bs">
                    <p class="font-size-r20 line-height-r48 text-align-c plr10 prr10 bs cor-fff font-bold">乡村法治</p>
                </div>
            </div>
            <div class="jfyh-l-top jfyh-l-top-h">
                <!-- 封面 -->
                <div class="div-banner h-330 img100" id="coverDiv">
                ...
                <div class=" h-100-400 clearfix bs">
                    ...
                    <div class="h-100 w-50-15 fl" id="popularizingLawEducationDiv">
                        ...
                        <div class="div-t-com w100 mtr20">
                            <div class="h-106 w100" id="popularizingLawEducation1"></div>
                            <div class="h-100-106 w100">
                                <ul class="div-jy-ul" id="popularizingLawEducation2"></ul>
                    ...
                    <div class="h-100 w-50-15 fr" id="caseDiv">
                        ...
                        <div class="clearfix"></div>
                        <div class="div-t-com w100 mtr20">
                            <div class="h-106 w100" id="caseList1"></div>
                            <div class="h-100-106 w100">
                                <ul class="div-jy-ul " id="caseList2"></ul>
        ...
        <div class="h926 smfw-r-w fr">
            <!-- 法律服务-->
            <div class="smfw-r-top main-div-box mbr10" id="expertDiv">
                <div class="comm-div-title font-size-0">
                    <em class="font-size-r16 cor-d62a1e font-bold plr15">法律服务</em>
<#--                    <div class="comm-pre-next-box posi-abso clearfix">-->
<#--                        <span class="fr">-->
<#--                            <i class="i-right" onclick="showMore('', '乡村法治-法律服务', '', 'legal_adviser')"></i>-->
<#--                        </span>-->
<#--                    </div>-->
                </div>
            ...
            <!-- 法律法规-->
            <div class="smfw-r-btn main-div-box" id="lawDiv">
                <div class="comm-div-title comm-div-title-w100 font-size-0 posi-rela">
                    ...
                    <div class="comm-pre-next-box posi-abso clearfix" id="lawChangePage">
                        <a href="javascript:void(0);" class="comm-pnb-pre fl active" onclick="changePage(-1)"></a>
                        <a href="javascript:void(0);" class="comm-pnb-next fl mlr10 active" onclick="changePage(1)"></a>
                    </div>
                </div>
                <div class="div-w-h-com">
                    <div class="cont-h1 plr30 mt20 bs h-x">
                        <ul class="div-ul-flfg prr30" id="lawList">
                            <li>
                                <p>
                                    <span class="font-size-r14 col-333 font-bold fl text-line-c1"></span>
                                    <span class="font-size-r14 col-999 fr"></span>
                                </p>
                            </li>
                        </ul>
                        <div class="none-data-ext1 hide" id="lawListNone">
                            <img class="none-data-p1"
                                 src="${uiDomain!''}/web-assets/_big-screen/35-xiangcunzhenxing/subject-cun/images/comm/icon-nonedata-ext1.png">
                            <p class="none-data-t1">暂无数据</p>
                        </div>
...
<script>
    ...
    var lawPageSize = Math.ceil(($('#lawList').parent().height() - 20) / $('#lawList').find('li').height()) - 1;
    var lawAllPage = 1;
    var lawPage = 1;
    function getLawList() {
        $('#lawList').empty();
        $.ajax({
            ...
            success: function (data) {
                if (data && data.rows && data.rows.length > 0) {
                    ...
                    $('#lawList').show();
                    if (lawPage == 1) {
                        lawAllPage = parseInt((data.total - 1) / lawPageSize) + 1;
                        if (lawAllPage == 1) {
                            $('#lawChangePage').hide();
                        } else {
                            $('#lawChangePage').show();
