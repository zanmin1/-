                ...
                <div class="pic-wrap-ext1 banner-ext1 notice-s4 ml15 mr15">
                    <div class="pic-wrap-c">
                        <div class="pic-wrap-i border-radius-10">
                            <img class="img-auto-c"
                                 src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/index-dj/ui-banner-1.png"/>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="${uiDomain}/app-assets/plugins/swiper-4.1.6/dist/js/swiper.min.js" type="text/javascript"
...
<script type="text/javascript">
            ...
            success: function (data) {
                ...
                if (data.total > 0) {
					...
					for (let i = 0; i < rows.length; i++) {
						...
						var comp = `<video  loop muted playsinline     x-webkit-airplay="true"     webkit-playsinline="true"  id="video\`+i+\`"  style="width: 100%;height: 100%;" preload="auto" controls  poster="poster" src="` + rows[i].staticUrl + `">`
                    ...
                    $('#experts').hide();
                    <%--$("#experts").parent().html('<div class="height-p85 flex flex-clm flex-jc flex-ac" style="padding-left: 8.5rem;">' +--%>
                    <%--		'<div class="data-none-ext1 img-p100">' +--%>
                    <%--		'<img src="${uiDomain}/app-assets/_wangge/zongzhi-mdjf/images/icon/icon-data-none-ext1.png">' +--%>
                    <%--		'</div>' +--%>
                    <%--		'<p class="font-size-17 cor-999 mt35">暂无数据</p>' +--%>
    ...
    function toMofang() {
        jump('<%=path%>/public/wap/PartyLeadingController/toMOfang.jhtml')
    }
    ...
    //跳转至微党课视频列表
    function moreVideo() {
        jump('${gbpDomain}/public/wap/appCommonInfoOpen/index.jhtml?tKey=wdk&isTop=yes&isPic=yes&mode=view&openNewPager=true')
    }
    ...
    function moreNews() {
        ...
        jump('${gbpDomain}/public/wap/appCommonInfoOpen/index.jhtml?tKey=djxw&isTop=yes&isPic=yes&mode=view&openNewPager=true')
    }
