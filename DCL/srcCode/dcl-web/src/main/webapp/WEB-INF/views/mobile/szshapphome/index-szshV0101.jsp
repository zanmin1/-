...
<head>
    ...
    <title>首页</title>
    <!-- 网格选择插件 -->
    <link rel="stylesheet" href="${uiDomain}/web-assets/plugins/layui-v2.5.5/layui/css/layui.mobile.css?version=1.0.2" />
    <link rel="stylesheet" href="${uiDomain}/app-assets/plugins/swiper-4.1.6/dist/css/swiper.min.css?version=1.0.2" />



    <link rel="stylesheet" href="${uiDomain}/web-assets/plugins/layui-v2.5.5/layui/css/layui.mobile.css" />
    <link rel="stylesheet" href="${uiDomain}/statics/app-assets/plugins/swiper-4.1.6/dist/css/swiper.min.css" />
    ...
    <!-------预定义css样式------->
    <link rel="stylesheet" href="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/css/notice.css?version=1.0.5"/>
    <style>
        .noDataTop{
            margin-top: 0px;
        }
    ...
    <div class="layui-row">
        <div class="layui-col-xs12 pt15 index-top">
            <div class="layui-col-xs12 h-28 pl15 pr15 bs mb10">
                ...
                <div class="layui-col-xs4">
                    ...
                    <%--                        <em><img class="img-12-9" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/gzh-index1/icon-gzh-xh.png?version=1.0.2" alt=""></em>--%>
                ...
                <ul class="index-lunbo-box posi-rela  box-radius10 ">
                    <div class="swiper-container swiper01 banner-ext1 w100 h-160 h-o">
                        <div class="swiper-wrapper" id="swipe-pic">
                            ...
                            <%--                                    <img src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/gzh-index1/bj01.png?version=1.0.2" alt="">--%>
                            <%--                                </li>--%>
                            <%--                            </div>--%>
                            <%--                            <div class="swiper-slide">--%>
                            <%--                                <li class="bs w100 img100">--%>
        ...
        <div class="layui-col-xs12 pt15 pl15 pr15 pb5">
            ...
            <div class=" layui-col-xs12  flex flex-ac flex-jr " id="menu-btn-01">
                ...
                <%--                        <img onclick="jumpPage('ssp')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/xczl-ssp.png?version=1.0.2" alt="">--%>
                <%--                    </div>--%>
                <%--                    <p class="font-size-12 cor-666 mt5 text-align-c text-line-c1">随手拍</p>--%>
                <%--                </a>--%>
                <%--                <a href="Javascript:;">--%>
                <%--                    <div class="index-ann-box-icon img100">--%>
                <%--                        <img onclick="jumpPage('xcvr')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/whly-xcvr.png?version=1.0.2" alt="">--%>
                <%--                    </div>--%>
                <%--                    <p class="font-size-12 cor-666 mt5 text-align-c text-line-c1">乡村VR</p>--%>
                <%--                </a>--%>
                <%--                <a href="Javascript:;">--%>
                <%--                    <div class="index-ann-box-icon img100">--%>
                <%--                        <img onclick="jumpPage('cwgk')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/xczl-cwgk.png?version=1.0.2" alt="">--%>
                <%--                    </div>--%>
                <%--                    <p class="font-size-12 cor-666 mt5 text-align-c text-line-c1">村务公开</p>--%>
                <%--                </a>--%>
                <%--                <a href="Javascript:;">--%>
                <%--                    <div class="index-ann-box-icon img100">--%>
                <%--                        <img onclick="jumpPage('nybk')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/snfw-nybk.png?version=1.0.2" alt="">--%>
                <%--                    </div>--%>
            ...
            <div class=" layui-col-xs12 mt20 flex flex-ac flex-jr" id="menu-btn-02">
                <%--                <a href="Javascript:;">--%>
                <%--                    <div class="index-ann-box-icon img100">--%>
                <%--                        <img onclick="jumpPage('xcjj')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/whly-xcjj.png?version=1.0.2">--%>
                <%--                    </div>--%>
                <%--                    <p class="font-size-12 cor-666 mt5 text-align-c text-line-c1">乡村简介</p>--%>
                <%--                </a>--%>
                <%--                <a href="Javascript:;">--%>
                <%--                    <div class="index-ann-box-icon img100">--%>
                <%--                        <img onclick="jumpPage('ycyp')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/whly-ycyp.png?version=1.0.2">--%>
                <%--                    </div>--%>
                <%--                    <p class="font-size-12 cor-666 mt5 text-align-c text-line-c1">一村一品</p>--%>
                <%--                </a>--%>
                <%--                <a href="Javascript:;">--%>
                <%--                    <div class="index-ann-box-icon img100">--%>
                <%--                        <img onclick="jumpPage('bszn')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/snfw-bszn.png?version=1.0.2" alt="">--%>
                <%--                    </div>--%>
                ...
                <%--                <a href="Javascript:;">--%>
                <%--                    <div class="index-ann-box-icon img100">--%>
                <%--                        <img onclick="jumpPage('all')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/application/quanbu.png?version=1.0.2" alt="">--%>
                <%--                    </div>--%>
            ...
            <div class="index-gonggao layui-col-xs12  mt15 bs flex flex-ac flex-jb ggClass" >
                <div class="mar-auto" onclick="openGg('1')">
                    <p class="text-align-c">
                        <i class="index-gonggao-logo img100">
                            <img src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/gzh-index1/icon-cunwugg.png?version=1.0.2" alt="">
                        </i>
                    </p>
                ...
                <div class="index-gonggao-text  bor1-left flex flex-jc  flex-clm" id="notices">
                    ...
                    <%--                                <img src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/gzh-index1/index-icon01.png?version=1.0.2" alt="">--%>
                    <%--                            </i></span>--%>
                    ...
                    <%--                                    <img src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/gzh-index1/index-icon02.png?version=1.0.2" alt="">--%>
                    <%--                                </i>--%>
                    <%--                            </span>--%>
                    <%--                    </p>--%>
                    <%--                    <p class="flex flex-ac flex-js mb5">--%>
                    ...
                    <%--                                    <img src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/gzh-index1/icon-new.png?version=1.0.2" alt="">--%>
                    <%--                                </i>--%>
                    <%--                            </span>--%>
                    <%--                        <span class="fl ml5 mt5">--%>
                    <%--                                <i class="index-gonggao-icon02 img100 mr10">--%>
            ...
            <div class="index-vr-box img100 layui-col-xs12 mt15 vr-class " id="show-img">
                <%--                <img onclick="jumpPage('fxdj')" src="${uiDomain}/app-assets/_jzfp/fujian-xczx-gongzhong/images/gzh-index1/icon15.png?version=1.0.2" alt="">--%>
            </div>
            <!-- 豆腐块 -->
...
<%--            </div>--%>
            ...
            <div class="layui-col-xs12 mt20 hide" id="zxzx">
                <div class="layui-col-xs12 flex flex-ac bor-btm-f0 pt10 pb10">
                    <i class="icon-title-ext1 font-size-12 ml0 mr5"></i>
                    <p class="font-size-16 font-bold line-height-24 cor-4d ml8">最新资讯</p>
                </div>
...
<script src="${uiDomain}/web-assets/common/js/jqry-9-1-12-4.min.js?version=1.0.1"></script>
<script src="${uiDomain}/app-assets/plugins/swiper-4.1.6/dist/js/swiper.min.js?version=1.0.1"></script>
<script src="${uiDomain}/web-assets/plugins/layui-v2.5.5/layui/layui.js?version=1.0.1"></script>

<script src="${uiDomain}/js/layer/layer.js?version=1.0.1"></script>
<script src="${uiDomain}/app-assets/extend/wap-group-select/js/ffcs.select.group.js?version=1.0.1"></script>
<script src="${uiDomain}/web-assets/extend/person-select/v1.0.0/js/custom_msgClient.js?version=1.0.1 "></script>
<script>
    ...
    var urlJson = {
        ...
        'all': "<%=path%>/public/wap/szshAppHome/indexqbyy.jhtml",
    ...
    function initComponent(){
        ...
        wapSelect1 = $('#orgDiv').initSelect(function (data) {
            ...
            $.ajax({
                type: "POST",
                url: "<%=path%>/oauth/rebind.js?version=1.0.1on",
                data: {
                    orgCode: data.orgCode,
    ...
    function initSwiperPic(){
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data==null){
                    var html = '';
                    var value = "${uiDomain}/app-assets/_jzfp/fujian-xczx/images/icon/icon-list-default-ext3.png?version=1.0.2";
    ...
    function initGgDiv(){
        $.ajax({
            ...
            url: '<%=path%>/public/wap/villageAdministrationApp/findReleaseListData.jhtml',
            data: {
                page:1,
                rows:3,
                catalogId:'10000020',
    ...
    function openGg(e){
        ...
        var url =null
        if (flag=="spt"){
            url ="${gbpDomain}/public/wap/appCommonInfoOpen/index.jhtml?tKey=tzgg&isTop=yes&isPic=yes&mode=view&openNewPager=true&userOrgCode="+orgCode;
        }else{
            url ="<%=path%>/oauth/channel/smarthome/transferStation.jhtml?redirect=prj_gbp/public/wap/appCommonInfoOpen/index.jhtml?tKey=tzgg&isTop=yes&isPic=yes&mode=view&openNewPager=true&userOrgCode="+orgCode;
            ...
            success: function (data) {
                if (data.total > 0) {
                    ...
                    for (let i = 0; i < rows.length; i++) {
                        if (rows[i].fileName != null) {
                            divStr += '<div class="layui-col-xs12 bor-btm-f0 flex pt10 pb10"  onclick="newsDetail(' + rows[i].infoOpenId + ')">' +
                                ...
                                '<p class="font-size-12 cor-999 flex mt5"><em class="width-10em text-line-c1 flex1">' + rows[i].pubOrg + '</em><em class="ml15">' + rows[i].pubDate.substring(0, 10) + '</em> </p>' +
                                '</div>' +
                                '</div>' +
                            ...
                            divStr += '<div class="layui-col-xs12 bor-btm-f0 pt10 pb10">' +
                                ...
                                '<div class="pic-wrap-c">' +
                                '<div class="pic-wrap-i border-radius-4">' +
                                '<video controls="{{false}}" style="width: 110%;height: 110%;" initial-time="0.01" autostart="false" loop="true" src="' + rows[i].staticUrl + '">' +
                                '</div>' +
                    ...
                    $("#NewsDiv").html('<div class="height-p85 flex flex-clm flex-jc flex-ac" >' +
                        ...
                        '<img style="width:80%;height:80%;" class="mt10" src="${uiDomain}/app-assets/_wangge/zongzhi-mdjf/images/icon/icon-data-none-ext1.png?version=1.0.2">' +
                        '</div>' +
                        '</div>' +
                        '<p class="font-size-17 cor-999 mt0">暂无数据</p>' +
                        '</div>');
                }
            },
            error: function (data) {
                // var divStr = '<div class="layui-col-xs12 bor-btm-f0 flex pt10 pb10"  onclick="newsDetail(' + 1+ ')">' +
                //     '<div class="flex1">' +
                //     '<p class="font-size-15 cor-4d font-bold height-3em text-line-c2"> 饭店烧烤了积分的史莱克发的开始减肥了附件的史莱克 </p>' +
                //     '<div class="flex flex-jb flex-ac mt5">' +
                //     '<p class="font-size-12 cor-999 flex mt5"><em class="width-10em text-line-c1 flex1">萨达大声道撒多 大萨达</em><em class="ml15">2021-12-29</em> </p>' +
                //     '</div>' +
                //     '</div>' +
                //     '<div class="pic-wrap-ext1 notice-s1 ml10">' +
                //     '<div class="pic-wrap-c">' +
                //     '<div class="pic-wrap-i border-radius-4">' +
                //     '<img src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg.jj20.com%2Fup%2Fallimg%2Ftp05%2F19100120461512E-0-lp.jpg&refer=http%3A%2F%2Fimg.jj20.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1643420387&t=726b2718af66dce06bd4514a0320d8a5">' +
                //     '</div>' +
                //     '</div>' +
                //     '</div>' +
                //     '</div>'
    ...
    function newsDetail(infoOpenId) {
        var url = '${gbpDomain}/public/wap/appCommonInfoOpen/homeShow.jhtml?infoOpenId=' + infoOpenId + '&tKey=byfw3&isTop=yes&isPic=yes&mode=view&openNewPager=true';
        jump(url);
    }
