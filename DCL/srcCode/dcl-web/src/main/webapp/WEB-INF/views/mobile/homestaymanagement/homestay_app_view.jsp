        ...
        <div class="layui-row">
            ...
            <div class="layui-col-xs12 pl15 pr15 posi-rela z-index">
                <div class="layui-col-xs12 border-radius-4 box-shadow-ext1 bg-fff notice-margin-ext1 pl15 pt10 pr15 pb15">
                    <p class="font-size-16 cor-333">${bo.homestayName}</p>
                    <div class="flex flex-ac flex-jb mt5">
                        <div class="flex flex-ac">
                            <p class="list-tag-ext4 font-size-12 cor-fff">${bo.accommodationName}</p>
                        </div>
                    </div>
                    <div class="flex flex-jb flex-ac mt10">
                        <p class="font-size-12 cor-666 flex1">详细地址：${bo.address}</p>
                        <button class="address layui-btn layui-btn-ext1"><i class="icon-pos-ext2"></i></button>
                    </div>
                </div>

                <div class="layui-col-xs12 pb25" id="nr">
                    <p class="posi-rela text-lh1 font-size-15 cor-333 pl15 mt20"><i class="notic-bar-ext1"></i>民宿介绍</p>
                    ${bo.homestayDesc}
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function() {
        ...
        $('.address').on('click', function() {
            if('${x}' != '') {
                location.href ='<%=path%>/public/wap/homestayManagementApp/showMap.jhtml?x=${x}&y=${y}';
            } else {
