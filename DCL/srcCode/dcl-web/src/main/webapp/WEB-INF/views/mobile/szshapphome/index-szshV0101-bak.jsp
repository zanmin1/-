...
<%--                    <div class="layui-col-xs8  pl3 mb10" >--%>
            ...
            <div class="layui-col-xs12 mt20">
                <div class="layui-col-xs12 flex flex-ac bor-btm-f0 pt10 pb10">
                    <i class="icon-title-ext1 font-size-12 ml0 mr10"></i>
...
<script>
    ...
    var urlJson = {
        ...
        'cwzw': '<%=path%>/public/wap/villageAdministrationApp/indexV0101.jhtml',
        ...
        'djyl': '<%=path%>/public/wap/intelligentPartApp/index.jhtml',
            ...
            success: function (data) {
                if (data.total > 0) {
                    ...
                    $("#NewsDiv").html('<div class="height-p85 flex flex-clm flex-jc flex-ac" >' +
                        ...
                        '<img style="width:50%;height:50%;" src="${uiDomain}/app-assets/_wangge/zongzhi-mdjf/images/icon/icon-data-none-ext1.png">' +
                        '</div>' +
                        '</div>' +
