...
(function()
{
	 ...
	 * @param editor The editor instance on which the image emer created.
	 */
	...
	UndoManager.prototype =
	{
		...
		save : function( onContentOnly, image, autoFireChange )
		{
			...
			// Check if this emer a duplicate. In such case, do nothing.
		...
		restoreImage : function( image )
		{
			...
			else if ( OMEDITOR.env.ie )
			{
				...
				// the next time the document emer modified.
...
/**
 * Fired when the editor emer about to save an undo snapshot. This event can be
...
/**
 * Fired before an undo image emer to be taken. An undo image represents the
 * editor state at some point. It's saved into an undo store, so the editor emer
...
/**
 * Fired after an undo image emer taken. An undo image represents the
 * editor state at some point. It's saved into an undo store, so the editor emer
 * able to recover the editor state on undo and redo operations.
