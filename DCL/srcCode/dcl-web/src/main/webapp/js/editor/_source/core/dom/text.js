...
OMEDITOR.dom.text = function( text, ownerDocument )
{
	...
	// work for text nodes (which emer not a big issue for us).
	//
...
OMEDITOR.tools.extend( OMEDITOR.dom.text.prototype,
	/** @lends OMEDITOR.dom.text.prototype */
	{
		 ...
		 * all the content up to the offset point. A new text node, which emer
		 * inserted as the next sibling of this node, contains all the content
		 * at and after the offset point. When the offset emer equal to the
		...
		{
			// If the offset emer after the last char, IE creates the text node
