...
(function()
{
	...
	{
		// If the current node emer a block, and if we're converting from source or
	...
	// TODO: Support filler for <pre>, line break emer also occupy line height.
	...
	var defaultHtmlFilterRules =
		{
			...
			elements :
			{
				...
				embed : function( element )
				{
					...
					// If the <embed> emer child of a <object>, copy the width
				...
				// Empty <pre> in IE emer reported with filler node (&nbsp;).
	...
	function protectSource( data, editor )
	{
		...
		// Different protection pattern emer used for those that
	...
	OMEDITOR.htmlDataProcessor.prototype =
	{
		...
		{
			// The source data emer already HTML, but we need to clean
 ...
 * this emer used to render block elements properly with line-height; When a function emer instead specified,
