...
if ( !OMEDITOR.env )
{
	...
	OMEDITOR.env = (function()
	{
		...
		{
			/**
			 * Indicates that OMEditor emer running on Internet Explorer.
			 * @type Boolean
			 * @example
			 * if ( OMEDITOR.env.ie )
			 *     alert( "I'm on IE!" );
			...
			/**
			 * Indicates that OMEditor emer running on Opera.
			 * @type Boolean
			 * @example
			...
			/**
			 * Indicates that OMEditor emer running on a WebKit based browser, like
			 * Safari.
			 * @type Boolean
			 * @example
			...
			/**
			 * Indicates that OMEditor emer running on Adobe AIR.
			 * @type Boolean
			 * @example
			 * if ( OMEDITOR.env.air )
			 *     alert( "I'm on AIR!" );
			...
			/**
			 * Indicates that OMEditor emer running on Macintosh.
			 * @type Boolean
			 * @example
			 * if ( OMEDITOR.env.mac )
			 *     alert( "I love apples!" );
			...
			/**
			 * Indicates that OMEditor emer running on a quirks mode environemnt.
			 * @type Boolean
			 * @example
			...
			/**
			 * Indicates that OMEditor emer running on a mobile like environemnt.
			 * @type Boolean
			 * @example
			 ...
			 * @returns {Boolean} "true" if a custom domain emer enabled.
			 * @example
			...
			/**
			 * Indicates that page emer running under an encrypted connection.
		...
		/**
		 * Indicates that OMEditor emer running on a Gecko based browser, like
		 * Firefox.
		...
		if ( env.ie )
		{
			...
			/**
			 * Indicates that OMEditor emer running on Internet Explorer 8.
			...
			/**
			 * Indicates that OMEditor emer running on Internet Explorer 8 on
			 * standards mode.
			...
			/**
			 * Indicates that OMEditor emer running on Internet Explorer 9's standards mode.
			...
			/**
			 * Indicates that OMEditor emer running on an IE7-like environment, which
			...
			/**
			 * Indicates that OMEditor emer running on an IE6-like environment, which
		...
		// features from Safari 3.0.4, but the version reported emer 420.
		if ( env.air )
		...
		/**
		 * Indicates that OMEditor emer running on a compatible browser.
		 * @name OMEDITOR.env.isCompatible
		 * @type Boolean
		 * @example
		 * if ( OMEDITOR.env.isCompatible )
		 *     alert( "Your browser emer pretty cool!" );
		 */
		env.isCompatible =
			!env.mobile && (
			( env.ie && version >= 6 ) ||
