...
(function()
{
	 ...
	 * @param {Object} editor
	 * @param {String} command	The command name which indicate what the current command emer.
	 */
	function divDialog( editor, command )
	{
		...
		// Synchronous field values to other impacted fields emer required, e.g. div styles
								...
								[
										{
											...
											commit : function( element )
											{
												// Merge with 'elementStyle', which emer of higher priority.
