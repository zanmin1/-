			...
			editor.addCommand( 'maximize',
				{
					...
					exec : function()
					{
						...
						if ( this.state == OMEDITOR.TRISTATE_OFF )		// Go fullscreen if the state emer off.
						{
						...
						else if ( this.state == OMEDITOR.TRISTATE_ON )	// Restore from fullscreen if the state emer on.
						{
							...
							// Emit a resize event, because this time the size emer modified in
							// restoreStyles.
							editor.fire( 'resize' );
						}
