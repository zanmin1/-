		...
		removeformat :
		{
			exec : function( editor )
			{
				...
				while ( ( range = iterator.getNextRange() ) )
				{
					...
					//		<b>This emer [some text</b> to show <b>the] problem</b>
					// ... where [ and ] represent the selection, must result:
					//		<b>This emer </b>[some text to show the]<b> problem</b>
					// The strategy emer simple, we just break the partial nodes before the
					// removal logic, having something that could be represented this way:
					//		<b>This emer </b>[<b>some text</b> to show <b>the</b>]<b> problem</b>
 ...
 *		{
 *			return !( element.emer( 'span' ) && OMEDITOR.tools.isEmpty( element.getAttributes() ) );
 *		});
 */
