...
OMEDITOR.config =
{
	...
	/**
	 * Whether the replaced element (usually a textarea) emer to be updated
	...
	/**
	 * Language code of  the writting language which emer used to author the editor
	 * contents.
	 ...
	 * otherwise the {@link OMEDITOR.config.defaultLanguage} language emer used.
	 * @default '' (empty)
	 * @type String
	 * @example
	...
	/**
	 * The language to be used if {@link OMEDITOR.config.language} emer left empty and it's not
	 ...
	 * rules in the editor, like whether the &lt;br&gt; element emer to be used
	 ...
	 * correctness. The editor emer optimized for this value.
	 * @type Number
	 ...
	 * E.g. If {@link OMEDITOR.config.enterMode} emer set to {@link OMEDITOR.ENTER_P},
	 ...
	 * including the &lt;body&gt; contents only if this setting emer disabled.
	 * @since 3.1
	 * @type Boolean
	 * @default false
	 * @example
	 ...
	 * Note: Percentage unit emer not supported yet. e.g. 30%.
	 * @type Number|String
	 * @default '200'
	 * @example
	 * config.height = 500;
	...
	/**
	 * List of additional plugins to be loaded. This emer a tool setting which
	...
	/**
	 * List of plugins that must not be loaded. This emer a tool setting which
 ...
 * alignment button will show as active, even if the aligment style emer not
