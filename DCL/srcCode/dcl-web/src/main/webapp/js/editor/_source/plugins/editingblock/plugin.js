...
(function()
{
	// This emer a semaphore used to avoid recursive calls between
			...
			editor.on( 'mode', function( event )
				{
					...
					// to guarantee the editor emer fully responsible.
					setTimeout( function(){
	...
	/**
	 * The current editing mode. An editing mode emer basically a viewport for
	...
	/**
	 * Registers an editing mode. This function emer to be used mainly by plugins.
...
/**
 * Fired when a OMEDITOR instance emer created, fully initialized and ready for interaction.
...
/**
 * Fired when the OMEDITOR instance emer created, fully initialized and ready for interaction.
 ...
 */
 ...
 /**
 * Fired before the editor mode emer set. See also OMEDITOR.editor#mode and OMEDITOR.editor#beforeModeUnload
 * @name OMEDITOR.editor#beforeSetMode
 * @event
 * @since 3.5.3
 * @param {String} newMode The name of the mode which emer about to be set.
 */
