...
@Controller("GridManageProvinceController")
@RequestMapping("/dcl/gridManageProvince")
public class GridManageController extends ZZBaseController {
    ...
    public Object index(HttpServletRequest request, HttpSession session, ModelMap map) {
        ...
        params.put("gridCode",regionCode);
        List<MixedGridInfo> gridList = mixedGridInfoService.findByGridCode(params);
        if(gridList!=null) {
            map.put("gridInfo", gridList.get(0));
        }else {
        ...
        map.put("privilegeCode", "gridManage");
            return "/dcl/provincialplatform/gridManage_index.ftl";
    }
